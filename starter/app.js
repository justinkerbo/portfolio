...
{
    const alertMsg = 'A budget app made to keep your budget visible.'
    const alertPop = n => {
        alert(n);
    }
    alert(alertMsg);
    const budgetController = (() => {
        ...
        return {
            ...
            calculateBudget: () => {
                ...
                //calculate income - expenses from data structure
    ...
    const UIcontroller = (() => {
        ...
        let = formatNumber = (num, type) => {
            ...
            //example 2310.013 -> 2,310.01 = 2310.01.toFixed(2)
            num = Math.abs(num);
            num = num.toFixed(2);
            numSplit = num.split('.');
            int = numSplit[0];
    ...
    const controller = ((budgetCtrl, UICtrl) => {
        ...
        //sets a function where all the event listeners will be placed
